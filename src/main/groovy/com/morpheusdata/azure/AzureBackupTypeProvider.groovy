 ...
 */
@Slf4j
class AzureBackupTypeProvider extends AbstractBackupTypeProvider {

	BackupExecutionProvider executionProvider;
	BackupRestoreProvider restoreProvider;

	AzureBackupTypeProvider(Plugin plugin, MorpheusContext morpheusContext) {
	...
	@Override
	String getCode() {
		return "azureBackupTypeProvider"
	}
	...
	Collection<OptionType> getOptionTypes() {
		return new ArrayList<OptionType>([
			new OptionType(
					...
					fieldName:'resourceGroup', fieldCode: 'gomorpheus.label.resourceGroup', fieldLabel:'Resource Group', fieldContext:'backup.config', fieldSet:'', fieldGroup:'Options',
					required:false, enabled:true, editable:true, global:false, optionSource: 'azureZonePools', optionSourceType:'azure',
			...
			new OptionType(
					...
					required:false, enabled:true, editable:true, global:false, optionSource: 'azureBackup.azureBackupVaults',
